...
\newcommand{\lstem}[1]{$\sqrt[\textrm{stem}]{#1}$}

% Incorrect Forms:
	%Lets you choose Greek or Latin characters
		% Hopefully
\newcommand{\iform}[2][G]{%
  \ifx G#1 \bgroup\sffamily\english{\textsuperscript{\tiny x}}\egroup\textel{#2}\else
  \ifx L#1 \bgroup\sffamily\english{\textsuperscript{\tiny x}}\egroup\textrm{#2}%
  \fi\fi
}
